---
title: "Git & Github for the UseR"
subtitle: R-Ladies Cville
...
* Pick up a parking pass if you haven't yet
* WiFi: VividCortex_Guest (no password)
* Follow us on Twitter: **@RLadiesCville**


![](https://d33wubrfki0l68.cloudfront.net/44c0a546d7a5da4b69de8869f673cbcf054e8301/6b1d4/images/r-ladiesglobal_rbg_online_logowithtext_horizontal.png)
---
<center><h1>Sponsors & Friends <span style="color:purple">(for now)</span></h1></center>

![](/Users/samanthatoet/Desktop/R-Ladies_Cville/images/rstudio.png)
![](/Users/samanthatoet/Desktop/R-Ladies_Cville/images/rconsort.png)
![](/Users/samanthatoet/Desktop/R-Ladies_Cville/images/vivid.png)

![](/Users/samanthatoet/Desktop/R-Ladies_Cville/images/github.png)

<span style="color:purple">Look at all of this empty space!</span>
---
<center><h1>Calling all speakers!</h1></center>
<center><span style="color:purple">and non-speakers!</span></center>

**What are some other ways to contribute?**

* Give a lightning talk *(2018 Cville Rladies showcase?)*

* Sponsor an event `r emo::ji("pizza")`
...
* Join us on Slack: https://cville-slack-invite-app.herokuapp.com/ 

* Contribute to our website and Github *(After today, you should know how to!)* 
...
* <span style="color:purple">**Git**</span> is a free and open sourced distributed version control system.

* It manages the evolution of set of files, or <span style="color:purple">**repository**</span>, between local and online versions.

* It allows a project to have multiple, independent <span style="color:purple">**branches**</span> of development, with the notion that some should eventually be <span style="color:purple">**merged**</span> back into the main development branch.
...
# 2. What is 
![](https://s19386.pcdn.co/wp-content/uploads/2017/10/github-logo-1.png)
# ?

---
# What is Github?

* <span style="color:purple">**Github**</span> is a web-based hosting service for version control – it’s where the online backup of your local project lives.
...
* In addition, there are two other important features of Github:
    ...
    + <span style="color:purple">**Issues**</span>: list of bugs, feature requests, to do’s, etc. 

    + <span style="color:purple">**Pull Requests**</span>: a formal proposal that says “Here are some changes I would like to make.” (It might be linked to a specific issue)
